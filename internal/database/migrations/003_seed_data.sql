...
-- 3. Books
INSERT INTO BOOK (ISBN, Title, Publication_Year, Selling_Price, Category, Stock_Quantity, Threshold, Publisher_ID) VALUES
    ('9780132350884', 'Clean Code', 2008, 39.99, 'Programming', 50, 10, 1),
    ('9780201485677', 'Refactoring', 1999, 44.99, 'Programming', 40, 10, 2),
    ('9780747532743', 'Harry Potter and the Philosopher''s Stone', 1997, 19.99, 'Fantasy', 100, 20, 2),
    ('9780553103540', 'A Game of Thrones', 1996, 24.99, 'Fantasy', 80, 15, 3);
...
-- 11. Publisher replenishment orders
